...
const WILDLIFE_DATA = {
  sightings: [
    ...
    {
      id: "w-elephant-gorumara-1",
      species: "Asian Elephant",
      subject: "Young Asian elephant grazing in grassland",
      location: {
      ...
      year: 2014,
      camera: "",
      images: ["assets/hobbies/wildlife-photography/asian-elephant-gorumara-web.jpg"],
      description: "",
      highlights: [],
      notes: ""
    },
    {
      id: "w-elephant-gorumara-2",
      species: "Asian Elephant",
      subject: "Asian elephant walking through grassland and shrub habitat",
      location: {
        name: "Gorumara National Park",
        city: "Jalpaiguri",
        stateOrRegion: "West Bengal",
      ...
      year: 2014,
      camera: "",
      images: ["assets/hobbies/wildlife-photography/asian-elephant-grassland-gorumara-web.jpg"],
      description: "",
      highlights: [],
      notes: ""
    },
    {
      id: "w-rhino-gorumara-egret",
      species: "Rhinoceros",
      subject: "Indian one-horned rhinoceros with cattle egret",
      location: {
        name: "Gorumara National Park",
        city: "Jalpaiguri",
        stateOrRegion: "West Bengal",
      ...
      year: 2014,
      camera: "",
      images: ["assets/hobbies/wildlife-photography/indian-rhino-egret-gorumara-web.jpg"],
      description: "",
      highlights: [],
      notes: ""
    },
    {
      id: "w-peafowl-gorumara",
      species: "Indian Peafowl",
      subject: "Male peacock in grassland",
      location: {
        name: "Gorumara National Park",
        city: "Jalpaiguri",
        stateOrRegion: "West Bengal",
      ...
      year: 2014,
      camera: "",
      images: ["assets/hobbies/wildlife-photography/indian-peacock-gorumara-web.jpg"],
      description: "",
      highlights: [],
      notes: ""
    },
    {
      id: "w-rhino-gorumara-river",
      species: "Rhinoceros",
      ...
      year: 2014,
      camera: "",
      images: ["assets/hobbies/wildlife-photography/indian-rhino-river-gorumara-web.jpg"],
      description: "",
      highlights: [],
      notes: ""
    }
