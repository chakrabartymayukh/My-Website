...
(function () {
  ...
  // Only the year is shown anywhere in the UI — visitDate strings like
  // "22 February 2023" or plain "1997" both reduce to a 4-digit year.
  function yearOf(visitDate) {
    const m = String(visitDate || "").match(/\d{4}/);
    return m ? m[0] : "";
  }
  ...
  const ICONS = {
    ...
    "Elephant Safari": `<path d="M3 19c3-8 6-11 9-11s6 3 9 11"/><path d="M8 19l4-8 4 8M6 19h12"/>`,
    "Boat Safari": `<path d="M3 19c3-8 6-11 9-11s6 3 9 11"/><path d="M8 19l4-8 4 8M6 19h12"/>`,
    "Jeep Safari": `<path d="M3 19c3-8 6-11 9-11s6 3 9 11"/><path d="M8 19l4-8 4 8M6 19h12"/>`,
    ...
    "Ox Cart Riding": `<path d="M2 19h4l1-3h5l2 3h4"/><circle cx="8" cy="20.5" r="1.3"/><circle cx="17" cy="20.5" r="1.3"/><path d="M12 16V9M12 9c2-2 4-2 6-1"/><path d="M8 6l-1.5-2M14 6l1.5-2"/>`,
    "Basketball": `<circle cx="12" cy="12" r="8"/><path d="M4 12h16M12 4v16M6 6c3 3 3 12 0 15M18 6c-3 3-3 12 0 15"/>`,
    "Sailing": `<path d="M12 3v14"/><path d="M12 4l6 8H12z" fill="currentColor" opacity="0.6"/><path d="M5 16l14 2"/><circle cx="12" cy="20" r="2"/>`,
    "Whale Watching": `<path d="M4 12c1-2 3-3 5-3s4 1 5 3M14 12c1-2 3-3 5-3s4 1 5 3"/><path d="M9 15c-1 2 0 5 3 6s5-1 6-3"/><circle cx="8" cy="10" r="1"/><circle cx="16" cy="10" r="1"/>`,
    "Trike Riding": `<circle cx="7" cy="17" r="2"/><circle cx="17" cy="17" r="2"/><path d="M9 17h8M12 17V6M4 15h4l3-5h2l3 5h4"/><circle cx="14" cy="4.5" r="1.2"/>`,
    "ATV Riding": `<circle cx="6" cy="17" r="2.2"/><circle cx="18" cy="17" r="2.2"/><path d="M5 13h14v3M9 13V7h6v6"/><path d="M11 8l2-1 2 1M12 9v3M8 15l2-1 4 0M14 15l2-1"/>`
  };
  ...
  function buildEntries(names) {
    return names.map(name => {
      const media = D.adventureLog
        ...
        .map(e => ({ type: "image", src: e.photo, alt: `${name} — ${e.place}`, place: e.place, date: yearOf(e.visitDate), region: e.region }));
      return {
        id: slugify(name),
        title: name,
