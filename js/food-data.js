...
(function () {
  ...
  const ICONS = {
    ...
    "Bhutanese": `<path d="M4 13.5c0-3.2 3.6-5.5 8-5.5s8 2.3 8 5.5-3.6 5-8 5-8-1.8-8-5z"/><path d="M9 8c-.6-1.4-.2-2.6.8-3.6M15 8c.6-1.4.2-2.6-.8-3.6"/><path d="M8 13.5c0-1.4 1.8-2.5 4-2.5s4 1.1 4 2.5"/>`,
    "Boozing": `<path d="M7 4h10l-1.2 4.5a4 4 0 0 1-3.8 3v5M12 16.5a4 4 0 0 1-3.8-3L7 4z"/><path d="M8.5 20h7M12 16.5V20"/><path d="M8 6h8"/>`
  };
